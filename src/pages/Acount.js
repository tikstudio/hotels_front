...
class Acount extends Component {
    ...
    handleSubmit = (ev) => {
        ev.preventDefault();
        this.validate();
        console.log(this.props.registrationRequest(this.state));
        this.props.registrationRequest(this.state)
    };

    render() {
        const {name, f_name, email, password} = this.state;
        return (
            <Wrapper>
                        ...
                        <form method="post" onSubmit={this.handleSubmit} className="sign_up_htm">
                            ...
                            <div className="group">
                                ...
                                <input
                                    value={password}
                                    onChange={this.handleChange}
                                    name="password" id="pass__first1" type="password" className="input"
                                    data-type="password"/>
